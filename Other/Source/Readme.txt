...
user in an INI file next to MKVToolNixPortable.exe called MKVToolNixPortable.ini.
...
copy AppNamePortable.ini from this directory to MKVToolNixPortable.ini next to
MKVToolNixPortable.exe. The options in the INI file are as follows:
